...
use crate::{storage::TelemetryStorage, TelemetryConfig, TelemetryError, TelemetryEvent, TelemetryStats, EventData};
        ...
        for event in &events {
            ...
            *stats.events_by_category.entry(category).or_insert(0) += 1;
            ...
            match &event.data {
                ...
                EventData::LatencyRecorded { operation, latency_bucket } => {
