...
impl Telemetry {
    ...
    pub async fn record_command(&self, command: &str) {
        ...
        self.collector.record(TelemetryEvent::command_used(command)).await;
    }
    ...
    pub async fn record_provider_used(&self, provider: &str, model: &str) {
        ...
        self.collector.record(TelemetryEvent::provider_used(provider, model)).await;
    }
    ...
    pub async fn record_error(&self, error_type: &str, recoverable: bool) {
        ...
        self.collector.record(TelemetryEvent::error_occurred(error_type, recoverable)).await;
    }
    ...
    pub async fn record_latency(&self, operation: &str, latency_ms: u64) {
        ...
        self.collector.record(TelemetryEvent::latency_recorded(operation, latency_ms)).await;
    }
    ...
    pub async fn record_feature(&self, feature: &str) {
        ...
        self.collector.record(TelemetryEvent::feature_used(feature)).await;
    }
    ...
    pub async fn record_session_start(&self) {
        ...
        self.collector.record(TelemetryEvent::session_started()).await;
    }
    ...
    pub async fn record_session_end(&self, duration_secs: u64) {
        ...
        self.collector.record(TelemetryEvent::session_ended(duration_secs)).await;
    }
